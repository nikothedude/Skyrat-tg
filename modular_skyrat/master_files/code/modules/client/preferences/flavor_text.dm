...
// SKYRAT EDIT ADDITION BEGIN -- INTERACTION PREFS

/datum/preference/text/interaction_preferences
	category = PREFERENCE_CATEGORY_NON_CONTEXTUAL
	savefile_identifier = PREFERENCE_CHARACTER
	savefile_key = "interaction_preferences"

/datum/preference/text/interaction_preferences/create_default_value()
	return "This field is bound by policy. Do not put anything in here if you haven't read interaction preferences policy yet."


/datum/preference/text/interaction_preferences/apply_to_human(mob/living/carbon/human/target, value, datum/preferences/preferences)
	return FALSE
